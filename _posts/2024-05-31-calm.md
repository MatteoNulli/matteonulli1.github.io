...
description: Vocabulary pruning and contrastive decoding for faster and better predictions 
tags: LargeLanguageModels, early-exiting
categories: LLMs
tabs: true
---
<!-- 
...
<table align="center">
  <tr align="center">
      <th><img src="/Users/matteo/Documents/University_related/MatteoNulli.github.io/_posts/blogpost_images/plots/softmax_shrink.jpeg" alt="Softmax Pruning approaches: illustration of (1) fixed and (2) decaying pruning methods for token importance preservation." style="width:90%; display:inline-block; margin: 0 2.5%;" /></th>
  </tr>
...
<table align="center" style="width: 100%; border-collapse: collapse; margin: 20px auto;">
    <tr>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/boxplot_topk_rank_evalsquad_google-t5_t5-large.png" style="max-width: 100%; height: 300px;">
            <br>
            <div style="margin-top: 10px;"><a id='figure-2a'>Figure 2.a:</a> Non fine-tuned T5-Large model, SQuAD Dataset </div>
        </td>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/boxplot_topk_rank_evalsquad_jvelja_t5-squad.png" style="max-width: 100%; height: 300px;">
            <br>
    ...
    <tr>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/boxplot_top1_rank_evalsamsum_google-t5_t5-large.png" style="max-width: 100%; height: 300px;">
            <br>
...
<table align="center" style="width: 100%; border-collapse: collapse; margin: 20px auto;">
    <tr>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/conf_metric_squad_google_t5.png" style="max-width: 100%; height: 300px;">
            <br>
            <div style="margin-top: 10px;"><a id='figure-3'>Figure 3:</a> Confidence vs F1 accuracy. T5-base model, SQuAD dataset </div>
        </td>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/conf_metric_squad_tuned.png" style="max-width: 100%; height: 300px;">
            <br>
...
<table align="center">
  <tr align="center">
      <th><img src="/_posts/blogpost_images/plots/IMG_0311.JPG" alt="Dynamic Contrastive Decoding: illustration of how we leverage Contrastive Decoding within model layers." style="width:90%; display:inline-block; margin: 0 2.5%;" /></th>
  </tr>
  <tr align="left">
...
<table align="center">
  <tr align="center">
      <th><img src="/_posts/blogpost_images/plots/jsds.png" alt="Evolution in  <i>JSD</i> distribution. T5-model, SQuAD Dataset." style="width:90%; display:inline-block; margin: 0 2.5%;" /></th>
  </tr>
  <tr align="left">
...
<table align="center" style="width: 100%; border-collapse: collapse; margin: 20px auto;">
    <tr>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/Final Plot Squad F1.png" style="max-width: 100%; height: auto;">
            <br>
        ...
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/Final Plot Squad Flops.png" style="max-width: 100%; height: auto;">
            <br>
...
<table align="center" style="width: 100%; border-collapse: collapse; margin: 20px auto;">
    <tr>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/Final Plot SamSum Rougl.png" style="max-width: 100%; height: auto;">
            <br>
        ...
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/Final Plot Samsum flops.png" style="max-width: 100%; height: auto;">
            <br>
            <div style="margin-top: 10px;"><b>FLOPs per sample during confidence estimation</b> for T5-Large and T5-Finetuned with <i>No</i>, <i>Fixed</i>, or <i>Decaying</i> reduction applied to the matrix</div>
        </td>
    </tr>
...
<table align="center" style="width: 100%; border-collapse: collapse; margin: 20px auto;">
    <tr>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/squadexit.png" style="max-width: 100%; height: auto;">
            <br>
            <div style="margin-top: 10px;"><b> a) </b> Average exit block across different minimum exit layers</div>
        </td>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/squadf1.png" style="max-width: 100%; height: auto;">
            <br>
...
<table align="center" style="width: 100%; border-collapse: collapse; margin: 20px auto;">
    <tr>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/sam_avg.png" style="max-width: 100%; height: auto;">
            <br>
            <div style="margin-top: 10px;"><b> a) </b> Average exit block across different minimum exit layers</div>
        </td>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/samsum_intermediate.png" style="max-width: 100%; height: auto;">
            <br>
...
<table align="center" style="width: 100%; border-collapse: collapse; margin: 20px auto;">
    <tr>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/squad_f1.png" style="max-width: 100%; height: auto;">
            <br>
            <div style="margin-top: 10px;"><b>F1 Metric</b> for T5-Large and T5-Finetuned with <i>No</i>, <i>Fixed</i>, or <i>Decaying</i> reduction applied to the matrix</div>
        </td>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/squad_flops.png" style="max-width: 100%; height: auto;">
            <br>
            <div style="margin-top: 10px;"><b>FLOPs per sample during confidence estimation</b> for T5-Large and T5-Finetuned with <i>No</i>, <i>Fixed</i>, or <i>Decaying</i> reduction applied to the matrix</div>
        </td>
    </tr>
...
<table align="center" style="width: 100%; border-collapse: collapse; margin: 20px auto;">
    <tr>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/rougesamsam.png" style="max-width: 100%; height: auto;">
            <br>
            <div style="margin-top: 10px;"><b>F1 Metric</b> for T5-Large and T5-Finetuned with <i>No</i>, <i>Fixed</i>, or <i>Decaying</i> reduction applied to the matrix</div>
        </td>
        <td style="text-align: center; padding: 10px;">
            <img src="/_posts/blogpost_images/plots/sam_flops.png" style="max-width: 100%; height: auto;">
            <br>
            <div style="margin-top: 10px;"><b>FLOPs per sample during confidence estimation</b> for T5-Large and T5-Finetuned with <i>No</i>, <i>Fixed</i>, or <i>Decaying</i> reduction applied to the matrix</div>
        </td>
    </tr>
...
<p align='center'>
<img src="/_posts/blogpost_images/plots/figure11.jpg" style="width:100%; display:inline-block; margin: 0 2.5%;" />
</p>
...
<p align='center'>
<img src="/_posts/blogpost_images/plots/figure12.jpg" style="width:100%; display:inline-block; margin: 0 2.5%;" />
</p>
...
<p align='center'>
<img src="/_posts/blogpost_images/plots/figure13.jpg" style="width:100%; display:inline-block; margin: 0 2.5%;" />
</p>
...
<p align='center'>
<img src="/_posts/blogpost_images/plots/figure14.jpg" style="width:100%; display:inline-block; margin: 0 2.5%;" />
</p>
